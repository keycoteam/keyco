...
In order to support loading of multiple wallets in keyco-qt, a few changes in the UI architecture will be needed.
...
----------------------
keyco.cpp is the entry point into keyco-qt, and as such, will require some minor modifications to provide hooks for
