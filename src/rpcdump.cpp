...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"keycoaddress\"\n"
            "\nEncrypts a private key corresponding to 'keycoaddress'.\n"
            "\nArguments:\n"
            "1. \"keycoaddress\"   (string, required) The keyco address for the private key (you must hold the key already)\n"
