                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Keyco-Coin") + " - ";
#ifdef ENABLE_WALLET
...
#ifdef ENABLE_WALLET
void BitcoinGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address, const QString& blob)
{
    //printf("blob %s \n", blob.toStdString().c_str());
