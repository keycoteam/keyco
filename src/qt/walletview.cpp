...
void WalletView::processNewTransaction(const QModelIndex& parent, int start, int /*end*/)
{
    ...
    QString blob = QString::fromStdString(ttm->blob(start, parent));
    emit incomingTransaction(date, walletModel->getOptionsModel()->getDisplayUnit(), amount, type, address, blob);
}
