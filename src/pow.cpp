...
{
    /* current difficulty formula, keyco - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
    ...
    //if (pindexLast->nHeight == Params().LAST_POW_BLOCK() || pindexLast->nHeight <= Params().LAST_POW_BLOCK() +2 ) bnNew = Params().ProofOfWorkLimit();
